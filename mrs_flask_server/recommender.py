...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Recommendation script")
    parser.add_argument('--model_path', type=str, required=True, help='Path to the model file')
    parser.add_argument('--user_data_path', type=str, required=True, help='Path to the user data file')
    parser.add_argument('--output_path', type=str, required=True, help='Path to save the recommendations')
